...
| `public/mall/textures/control-deck-panel.png` | User-provided original illustration | `ac947d0388e19a132702a32d351512659f6054cc736dbc1dcfc4002cd75150f3` | Cropped to the physical panel bounds, given a cache-safe asset URL, and mounted as decorative cabinet hardware; the real ride controls and semantics remain separate HTML. |
