# Gates: Jolt rideLab phase 1

OWNS: app/mall/ride-lab/**, app/mall/_ride-lab/**, lib/ride-lab-feature.ts, lib/ride-lab-feature.test.ts, proxy.ts, docs/design/ride-feedback-points.md, docs/testing/ride-lab-phase-1.md, docs/testing/ride-lab-measurements.json, scripts/verify-ride-lab-browser.mjs, scripts/verify-ride-lab-production-gate.mjs, scripts/verify-ride-lab-evidence.mjs, package.json, package-lock.json

Scope: deliver a development-only Jolt motorcycle test arena that leaves the authored Rapier mall ride unchanged and makes its Phase 1 handling measurable and tunable.
...
- [x] G1: native Jolt handling, ramp travel, intent feedback, route gating, and tuning seams behave deterministically under focused tests
  CHECK: npm run test:ride-lab
  EXPECT: /# fail 0/
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/jeromeiovelarde/Dev/itsmeio-dev-jolt-ridelab; path=cf8a55d24f3a/23 entries; EXPECT=matched; output-sha256=e1c14a14a4b9e621b89934b119fd6b4af96d77021c34e50e30383cbf4788c13c; output-bytes=5705
...
- [x] G4: existing mall tests and a production build pass while both optional routes remain closed
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/jeromeiovelarde/Dev/itsmeio-dev-jolt-ridelab; path=cf8a55d24f3a/23 entries; EXPECT=matched; output-sha256=b2f55009edbf8ddcec399ff065480b277ffeaa630d53a5596539b30f21f69d18; output-bytes=8232

- [x] G5: browser verification covers isolated availability, first-frame input feedback, categorized tuning, reload, context loss, reduced motion, and mobile layout
