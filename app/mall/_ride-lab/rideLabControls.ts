...
export const RIDE_LAB_CONTROLS: readonly RideLabControl[] = [
  ...
  control("highSpeedTorqueStartMps", "Torque falloff start", "Drivetrain", 0.5, "Speed where upper-band drive begins tapering, in metres per second."),
  control("highSpeedTorqueEndMps", "Torque falloff end", "Drivetrain", 0.5, "Speed where upper-band drive reaches its minimum multiplier, in metres per second."),
  control("highSpeedTorqueMultiplier", "Upper-band drive", "Drivetrain", 0.05, "Share of engine drive retained at and above the falloff end speed."),
  ...
  control("turnAssist", "Curvature assist", "Steering & assist", 0.05, "Arcade alignment strength that preserves momentum while guiding the bike into the requested turn."),
  control("turnAssistRadiusMeters", "Assisted turn radius", "Steering & assist", 1, "Target high-speed turn radius used by curvature assist, in metres."),
  control("turnAssistMaxYawRate", "Assisted maximum yaw", "Steering & assist", 0.05, "Maximum assisted heading rotation in radians per second."),
  ...
  control("cameraNearDistance", "Starting follow distance", "Camera & feedback", 0.1, "Closer chase-camera distance used at rest."),
  control("cameraNearFov", "Starting FOV", "Camera & feedback", 1, "Tighter field of view used at rest."),
  control("cameraCruiseSpeedMps", "Camera cruise speed", "Camera & feedback", 0.5, "Speed where the camera reaches its normal distance and 52 degree FOV."),
  control("cameraThrottlePunchDistance", "Throttle camera kick", "Camera & feedback", 0.05, "Immediate chase-camera pullback when throttle begins."),
  control("cameraThrottlePunchFov", "Throttle FOV kick", "Camera & feedback", 0.25, "Immediate field-of-view punch when throttle begins."),
  control("cameraThrottlePunchDecay", "Throttle kick settle", "Camera & feedback", 0.5, "How quickly the throttle camera impulse settles."),
  control("cameraSteerOrbitRadians", "Steering camera orbit", "Camera & feedback", 0.005, "Maximum horizontal orbit around the rider while steering; the camera keeps looking back toward the rider."),
  control("cameraSteerOrbitResponse", "Steering orbit response", "Camera & feedback", 0.25, "How gradually the camera enters and leaves the steering orbit."),
  ...
  control("speedLineOnsetOpacity", "Speed-line onset", "Camera & feedback", 0.01, "Initial line strength at the threshold before the high-speed fade builds."),
  control("speedLineBurstOpacity", "Speed-line burst", "Camera & feedback", 0.01, "Brief extra line strength when crossing the threshold."),
  control("speedLineBurstDecay", "Line burst settle", "Camera & feedback", 0.5, "How quickly the threshold burst settles into continuous lines."),
